...
INTERNAL_TOOL_TOKEN = os.environ.get("ALA_INTERNAL_TOKEN") or os.environ.get("ODYSSEUS_INTERNAL_TOKEN") or secrets.token_hex(32)
INTERNAL_TOOL_HEADERS = ("X-ALA-Internal-Token", "X-Odysseus-Internal-Token")
...
def require_admin(request: Request):
    ...
    # (a) header-direct (caller set X-ALA-Internal-Token), or
    # (b) the auth middleware already validated the token and stamped
    #     request.state.current_user = "internal-tool".
    try:
        for header_name in INTERNAL_TOOL_HEADERS:
