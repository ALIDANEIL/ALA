...
<#
  ...
  Output layout:
    ...
    dist\ALA\static\...
    dist\ALA\scripts\...
    dist\ALA\mcp_servers\...
    dist\ALA\services\hwfit\data\...
...
& $pyExe -m PyInstaller --noconfirm --clean --onedir --noconsole --icon=static/icon.ico --name ALA @dataArgs launcher.py
